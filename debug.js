            ...
            this._FUNC = {
                ...
                RERENDER: () => {
                    ...
                    if ( this._STATE.elemText.screenInfo !== screenSize.width && this._STATE.elemText.screenInfo !== screenSize.height ) {
                        this._STATE.elemText.screenInfo = `${screenSize.width} X ${screenSize.height} S_scale ${Math.floor( ( screenSize.width + screenSize.height ) / 100 )}`;
                ...
                INIT_DEBG_SCREEN: () => {
                    ...
                    this._ELEM_LIST.screenInfo.disabled = true;
...
setInterval( DEBUG._FUNC.SHOW_CHUNK, 1000 );
